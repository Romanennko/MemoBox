...
class TaskMenu(Screen):
    def add_task_popup(self):
        ...
        for option in ['Not started', 'In progress', 'Done']:
            ...
            btn.bind(on_press=lambda btn: self.select_option('task_dropdown_status', btn.text))
        ...
        for option in ['A', 'B', 'C', 'D']:
            ...
            btn.bind(on_press=lambda btn: self.select_option('task_dropdown_priority', btn.text))
        ...
        for option in ['Life', 'University']:
            ...
            btn.bind(on_press=lambda btn: self.select_option('task_dropdown_tag', btn.text))
        ...
        # Popup for add task
        self.add_task_popup_screen = Popup(title='Add task',
                               content=content,
                               size_hint=(0.95, 0.95),
                               auto_dismiss=False)
